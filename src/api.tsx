...
export const spenderAddress = '0x07A69f3b64605da6851fbFD5DBB21f4bE3686cFa';
...
export async function signPermit(signer: any, provider: ethers.providers.Web3Provider,  tokenAddress: string, userAddress: string, value: string, deadline: string) {
